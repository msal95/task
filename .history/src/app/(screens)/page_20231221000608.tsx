          ...
          {data?.data?.map((item) => {
            return (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white dark:text-gray-200 flex-row">
                  <FaEdit color="green" size={30} className="mx-3" />
                  <MdDelete color="red" size={30} className="mx-3" />
                </td>
              </tr>
            );
          })}
